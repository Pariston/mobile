...
namespace BBC2
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj13_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::BBC2.Models.Article dataRoot;
            ...
            {
                 global::BBC2.Models.Article data = args.NewValue as global::BBC2.Models.Article;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::BBC2.Models.Article was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::BBC2.Models.Article);
                ...
                this.Update_((global::BBC2.Models.Article) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::BBC2.Models.Article newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::BBC2.Models.Article obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::BBC2.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void SetDataRoot(global::BBC2.MainPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::BBC2.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_poziomki(obj.poziomki, phase);
                    }
                }
            }
            private void Update_poziomki(global::System.Collections.Generic.List<global::BBC2.Models.Article> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 13:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::BBC2.Models.Article) element13.DataContext);
